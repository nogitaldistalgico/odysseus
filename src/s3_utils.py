...
def _sync_upload_and_presign(filepath: str, object_name: str, expiration: int = 1800) -> str:
...
async def upload_video_and_get_presigned_url(filepath: str, object_name: str, expiration: int = 1800) -> str:
    """
    Asynchronously upload a local video file to S3 and return a secure presigned HTTPS URL.
    The URL expires after `expiration` seconds (default 30 mins).
    """
